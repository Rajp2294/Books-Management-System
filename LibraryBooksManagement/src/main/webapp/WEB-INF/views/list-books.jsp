...
<body>
	...
	<div class="container">
		...
		<form action="/LibraryBooksManagement/books/search" class="form-inline">

			<!-- Add a button -->
			<a href="/LibraryBooksManagement/books/showFormForAdd"
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/LibraryBooksManagement/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/LibraryBooksManagement/books/delete?bookId=${tempBook.id}"
